# ---------------------------------------
# DSA 230, Intro to Data Science
# Homework 1: GPA Calculator
# Keerthi Gurram
# Last Modified: September 15, 2024
# ---------------------------------------
# This program calculates the GPA based on user inputs for the number 
# of courses, the letter grades received, and the number of credits.
# ---------------------------------------
